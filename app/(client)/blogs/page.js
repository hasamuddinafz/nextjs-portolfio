...
import Link from 'next/link'; // Next.js için istemci tarafı navigasyonu için Link kullanılır
    ...
    <div>
      <header className="text-center text-black bg-light py-10">
        <div className="container">
          <h1 className="poppins-bold text-5xl py-5">
            My<span className="orange-color"> Blogs </span>{' '}
          </h1>
          <hr />
        </div>
      </header>
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-center p-4 md:p-4">
                    <div>
                      <Image
                        ...
                        width={400}
                        height={400}
                        className="card-img-top img-fluid w-full h-full"
                        alt="Blog"
                      />
                    </div>
                    <div className="md:p-4 md:w-3/4 py-4 px-2">
                      ...
                      <p className="text-gray-600">
                        ...
                        <span className="font-bold text-danger"> {post.category.category} </span>
                      </p>
                      <div
                        className="text-dark"
                        dangerouslySetInnerHTML={{ __html: sanitizeHtml(post.description, 150) }}
                      />
